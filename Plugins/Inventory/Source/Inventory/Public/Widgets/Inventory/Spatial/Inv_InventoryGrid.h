...
private:
	...
	void SetItemSlottedImage(const UInv_SlottedItem* SlottedItem, const FInv_GridFragment* GridFragment, const FInv_ImageFragment* ImageFragment) const;
	...
	bool ShouldConsumeHoveredItemStacks(const int32 HoveredStackCount, const int32 RoomInClickedSlot);
